...
### The project `Activation Atlas` tries to reverse engineer this black box to better understand what neuronal networks "think" in certain parts of an image – so they ask: <br> What do you see in the first 10 x 10px?...in the second 10 x 10px?...and so on. 
